...
Nas últimas décadas, houve uma crescente busca por métodos mais eficientes, seguros e transparentes para acompanhar os processos eleitorais. Nesse contexto, a tecnologia Blockchain, introduzida formalmente no contexto de moedas digitais por Nakamoto (2008)\cite{nakamoto2008bitcoin}, surge como uma solução promissora para melhorar a integridade e confiabilidade das votações eletrónicas.
...
\begin{enumerate}
    ...
    \item \textbf{Aus{\^e}ncia de anonimato verific{\'a}vel}: a maioria das solu{\c{c}}{\~o}es n{\~a}o garante que o voto seja an{\'o}nimo ao mesmo tempo em que permite rastreabilidade para fins de auditoria.
\end{enumerate}
...
\begin{itemize}
    \item \textbf{Descentraliza{\c{c}}{\~a}o total} dos registos de voto mediante blockchain p{\'u}blica (Ethereum Sepolia);
...
\begin{enumerate}
    ...
    \item Projeto e implementa{\c{c}}{\~a}o de smart contracts robustos em Solidity que gerem o ciclo de vida da elei{\c{c}}{\~a}o (registo, vota{\c{c}}{\~a}o, apura{\c{c}}{\~a}o) e garantam a unicidade do voto por meio de identidades digitais.
    ...
    \item Desenvolvimento de uma interface acessível (React + Ethers.js) que siga as diretrizes WCAG 2.1, permitindo a participação inclusiva de utilizadores com diferentes necessidades.
    ...
    \item Valida{\c{c}}{\~a}o qualitativa por meio de testes de usabilidade com utilizadores reais, coletando feedback sobre confian{\c{c}}a, percep{\c{c}}{\~a}o de seguran{\c{c}}a e experi{\^e}ncia de voto.
\end{enumerate}

\subsection{Contribuições}
\begin{enumerate}
    \item \textbf{Metodol{\'o}gica}: aplica{\c{c}}{\~a}o do framework \textit{Design Science Research} (DSR) para o desenvolvimento rigoroso de artefactos tecnol{\'o}gicos em contextos eleitorais.
...
\begin{description}
    ...
    \item[Cap{\'i}tulo VII: Conclus{\~o}es] Sintetiza resultados, contribui{\c{c}}{\~o}es e o roadmap de evolu{\c{c}}{\~a}o do artefacto.
\end{description}
